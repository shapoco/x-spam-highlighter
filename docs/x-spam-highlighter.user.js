...
//{ regexes:[/あ/g], add:100}, // テスト用
  { regexes:[/お金|現金|\d*万円/g, /配布|配り|配る|配っ[てた]?|プレゼント|分配/g], add:50},
  { regexes:[/びんぼ[ーう]|貧乏|貧困|底辺/g, /成り?上が?り/g], add:50},
  { regexes:[/(気にな((って)?る|っちゃう)|興味[がの]?ある|ちょっと好きな?|[見み]てみたい)(方|かた|人|ひと|[男女][性子]|お(兄|に[いぃ]|姉|ね[えぇ])さん)(だけ)?[にを]?(いいね|ハート|♥)/g], add:50},
  ...
  { regexes:[/抽選/g], add:10},
  { regexes:[/当選/g], add:10},
  { regexes:[/稼(げ[るば]|ぐ|い[だで])/g], add:10},
  { regexes:[/儲(か(る|り|った)|け[たて]?)/g], add:10},
  { regexes:[/売り?上げ?|収益|利益|収入|手取り?/g], add:10},
  { regexes:[/爆益/g], add:10},
  ...
  { regexes:[/楽天/g], add:5},
  { regexes:[/秘密|ヒミツ|内緒|ナイショ/g], add:5},
